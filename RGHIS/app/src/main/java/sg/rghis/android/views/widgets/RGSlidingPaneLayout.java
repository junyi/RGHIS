 ...
 */
public class RGSlidingPaneLayout extends ViewGroup {
    ...
    public RGSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public RGSlidingPaneLayout(Context context, AttributeSet attrs) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(RGSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(RGSlidingPaneLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(RGSlidingPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(RGSlidingPaneLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == RGSlidingPaneLayout.this) {
